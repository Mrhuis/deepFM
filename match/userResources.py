...
from config import USER_RECOMMEND_RESOURCE_DIR, HIGH_MATCHING_CANDIDATE_RESOURCE_COUNT, TRAINING_MODELS_DIR,RECOMMEND_USED_RESOURCES
...
def generate_single_user_recommendations(user_key: str, directory_name: str = None, model_name: str = None):
    """
    ...
    print(f"为用户 {user_key} 处理 {len(resource_keys)} 个资源")
...
def get_user_recommendations(user_key: str, directory_name: str = None, model_name: str = None) -> List[Dict[str, Any]]:
    ...
    try:
        # 首先生成或更新用户的推荐资源
        generate_single_user_recommendations(user_key, directory_name, model_name)
...
def mark_resource_as_used(user_key: str, resource_key: str, directory_name: str = None) -> bool:
    """
